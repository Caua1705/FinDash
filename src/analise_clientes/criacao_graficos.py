...
def gerar_graficos(df_filtrado_clientes,df_filtrado_fornecedores):
    ...
    with col2:
        ...
        fig1=px.bar(df_filtrado_fornecedores,x="Cliente / Fornecedor",y="Despesas",title="Participação dos principais fornecedores nas despesas",color="Cliente / Fornecedor",orientation="h")
