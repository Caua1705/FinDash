...
def gerar_graficos(df_receitas_despesas,df_receitas_mensais,filtro_mes) -> None:
    ...
    with col1:    
        ...
        fig1=px.bar(df_receitas_despesas,x="Centro de Custo",y=["Receitas","Despesas"],barmode="group",labels={"Categoria": "Categoria", "valor": "Valor"},title=f"Receitas e Despesas por Centro de Custo em {filtro_mes}")
